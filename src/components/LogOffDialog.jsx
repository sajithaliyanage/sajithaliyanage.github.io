...
function ActionButton({ icon, label, hoverColor, onClick }) {
  ...
  return (
    <button
      className="flex flex-col items-center gap-2 bg-transparent border-none cursor-pointer px-8 py-3 rounded"
      style={{
...
export default function LogOffDialog() {
  const { logOffDialogOpen, hideLogOffDialog, setSystemState, closeAllWindows } = useStore()
  const play = useSound()

  if (!logOffDialogOpen) return null
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center" style={{ zIndex: 99990 }}>
      ...
      >
        ...
        {/* Body */}
        <div
          className="flex items-center justify-center gap-6 py-8 px-6"
          style={{
        ...
        >
          ...
          <ActionButton
            ...
            icon={{
              ...
              border: '#106810',
              borderHover: '#60d060',
              svg: <img src="/icons/Restart.png" alt="Switch User" width="28" height="28" style={{ objectFit: 'contain' }} />,
            }}
          ...
          <ActionButton
            ...
            icon={{
              ...
              border: '#a06800',
              borderHover: '#f0d060',
              svg: <img src="/icons/LogOff.ico" alt="Log Off" width="28" height="28" style={{ objectFit: 'contain' }} />,
            }}
